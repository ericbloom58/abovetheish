...
<div class="col-md-12 col-xs-1">
            ...
            <div class="panel panel-default active">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                            ...
                            <input type="checkbox" checked>QuickBooks Desktop (QBDT)<br>
                            <ul style="list-style:none;">
                                ...
                                <li><input type="checkbox" checked>QBDT Premier Accountant</li>
                                <li><input type="checkbox" checked>QB Enterprise (QBES)</li>
                                 <!--   <ul style="list-style:none;">
                                ...
                                <li><input type="checkbox" checked>QB Enterprise Accountant </li>
                            </ul>
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
						<div class="col-md-6 col-xs-6">
                            ...
                            <input type="checkbox" > Payroll Taxes and Forms <br>
                            <ul style="list-style:none;">
                                <li><input type="checkbox">DIY</li>
                                <li><input type="checkbox">Do-It-For-You</li>
                            </ul>
                            <input type="checkbox" > Additional Services / Information <br>
                            <ul style="list-style:none;">
                                <li><input type="checkbox">Time Tracking</li>
                                <li><input type="checkbox">Time & Expenses</li>
                            </ul>
                            <input type="checkbox" checked> Reports - Business Overview <br>
                            <ul style="list-style:none;">
                                <li><input type="checkbox">Reports - Profit & Loss</li>
                            </ul>
                            <input type="checkbox" checked> Reports - Accountant <br>
                            <ul style="list-style:none;">
    ...
    <a class="button" href="/admin/presentation/query3result"> Submit </a>
                        </form>
